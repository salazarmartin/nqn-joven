...
export default function Edit({ auth, material }) {
    ...
    const handleRemoveExistingPlan = (planPath) => {
        setExistingPlanes(existingPlanes.filter((p) => p !== planPath));
        setData("deleted_planes", [...data.deleted_planes, planPath]);
        toast.success("Plan marcado para eliminar");
    };
    ...
    const handleSubmit = (e) => {
        ...
        data.deleted_planes.forEach((plan, index) => {
            formData.append(`deleted_planes[${index}]`, plan);
        });
        ...
        put(`/material/${material.id}`, {
            ...
            onError: (errors) => {
                toast.error("Error al actualizar el material", { id: toastId });
