...
class ComentLink extends Model
{
    use HasFactory, SoftDeletes;

    protected $table = 'coment_links';
    ...
    {
        return $this->hasMany(ComentLink::class, 'coment_padre_id')
    ...
    {
        return $this->belongsTo(ComentLink::class, 'coment_padre_id');
    }
